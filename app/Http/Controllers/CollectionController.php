...
class CollectionController extends Controller
{
    ...
    public function getCompanyCollectionList(Request $request)
    {
        ...
        $resumeList   = ResumeCollection::query()->where('company_id', $cid)
            ...
            ->get([
                "resumes.id", "resume_collections.id as collectionId", "resumes.openid", "avatar", "resumes.name", "sex", "age", "education" ,"phone","salary", "position", "resumes.created_at", "city", "education_experience", "internship_experience", "project_experience", "self_assessment"
            ])
            ->toArray();
