...
class CollectionController extends Controller
{
    ...
    public function getCompanyCollectionList(Request $request)
    {
        ...
        $resumeList   = ResumeCollection::query()->where('company_id', $cid)
            ...
            ->get([
                "resumes.worker_id", "resume_collections.id as collectionId", "resumes.openid", "avatar", "resumes.name", "sex", "age", "education" ,"phone","salary", "position", "resumes.created_at", "city", "education_experience", "internship_experience", "project_experience", "self_assessment"
            ])
            ->toArray();
    ...
    public function getWorkerCollectionList(Request $request)
    {
        ...
        $workOrderList   = WorkerOrderCollection::query()->where('worker_id', $wid)
            ...
            ->get([
                ...
                "work_orders.status", "user_type", "order_type", "companies.name as company_name", "companies.avatar as company_avatar", "content", "place", "salary", "education", "dateline", "service_charge", "description", "collection_count",
            ])
            ->toArray();
